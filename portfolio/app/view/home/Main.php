			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<div class="about-content wow fadeInUp" data-wow-delay="0.8s">
						...
						<p>Além do meu entusiasmo pela área de tecnologia, também tenho uma parte muito especial na
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="counter-stats">
						<h3 class="sub-title"><i class="fa fa-heart"></i>Curiosidades</h3>
				...
				<div class="col-md-3 col-sm-6 col-xs-12 portfolio-box institucional">
					<div class="single-portfolio">
						<a href="#popup-3" class="has-popup">
							<img src="<?php echo DIRIMG.'tcc.png' ?>" class="Portfolio Image" alt="Projeto do meu TCC" />
							<div class="single-portfolio-overlay">
								<h2>Teen Invest</h2>
					...
					<div id="popup-3" class="popup-box mfp-fade mfp-hide">
						<div class="content">
							<div class="image">
								<img src="<?php echo DIRIMG.'tcc.png' ?>" alt="Projeto do meu TCC">
							</div>
							<div class="desc">
								<h4>Teen Invest (Projeto pessoal - TCC ETEC)</h4>
	...
	<section class="pricing" id="pricing">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="load-more-portfolio">
						<a href="<?PHP echo DIRPAGE.'planos/' ?>">Ver Outros Planos</a>
					</div>
				</div>
			</div>
		</div>
